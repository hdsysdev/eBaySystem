...
CONCAT(
'<p style="font-size:16px;text-align:justify">This ',ebay.[Range name],' ', ebay.Type, ' is ', ebay.Side,
' and comes in ', lower(ebay.[Main colour]), ' with an adjustable plinth. It is made in a ', (CASE WHEN prod_child.[modern traditional] = 'M' THEN 'modern ' ELSE 'traditional ' END),
