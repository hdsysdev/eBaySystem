...
CASE
WHEN ebay.eTitle != '' THEN UPPER(ebay.eTitle)
ELSE CONCAT('EDIT TITLE___',UPPER(prod_parent.prodtitl))
END AS Title,
...
CASE 
--WHEN PRODUCT ON SALE AND SALE PRICE BELOW OR EQUAL 399 --> ROUNDS IT DOWN, ADDS SHIPPING COST AND TAKES OFF 6 PENCE
WHEN prod_child.onsale = 1 AND prod_child.saleprice <= 399 THEN FLOOR((prod_child.saleprice) + [Delivery Service 1 Price])- 0.06
--WHEN PRODUCT ON SALE AND SALE PRICE OVER 399 --> ROUNDS IT DOWN AND TAKES OFF 6 PENCE
WHEN prod_child.onsale = 1 AND prod_child.saleprice > 399 THEN FLOOR(prod_child.saleprice) - 0.06
...
WHEN prod_child.onoffer = 1 AND prod_child.offerprice > 399 THEN FLOOR(prod_child.offerprice) - 0.06
...
WHEN prod_child.onsale = 0 AND prod_child.onoffer = 0 AND prod_child.price <= 399 THEN FLOOR((prod_child.price) + [Delivery Service 1 Price])- 0.06
--WHEN PRODUCT NOT ON SALE AND NOT ON OFFER AND ORIGINAL PRICE OVER 399 --> ROUNDS IT DOWN AND TAKES OFF 6 PENCE
WHEN prod_child.onsale = 0 AND prod_child.onoffer = 0 AND prod_child.price > 399 THEN FLOOR(prod_child.price) - 0.06
...
WHEN prod_child.onsale = 1 AND prod_child.saleprice <= 399 AND prod_child.saleprice < prod_child.rrp THEN CONCAT(FLOOR(prod_child.rrp) + [Delivery Service 1 Price],'.00')
...
WHEN prod_child.onsale = 1 AND prod_child.saleprice > 399 AND prod_child.saleprice < prod_child.rrp THEN CONCAT(FLOOR(prod_child.rrp),'.00')
...
WHEN prod_child.onsale = 1 AND prod_child.saleprice <= 399 AND prod_child.saleprice >= prod_child.rrp THEN CONCAT(FLOOR(prod_child.saleprice + (prod_child.saleprice * 0.30)) + [Delivery Service 1 Price],'.00')
...
WHEN prod_child.onsale = 1 AND prod_child.saleprice > 399 AND prod_child.saleprice >= prod_child.rrp THEN CONCAT(FLOOR(prod_child.saleprice + (prod_child.saleprice * 0.30)),'.00')
...
WHEN prod_child.onoffer = 1 AND prod_child.offerprice <= 399 AND prod_child.offerprice < prod_child.rrp THEN CONCAT(FLOOR(prod_child.rrp) + [Delivery Service 1 Price],'.00')
...
WHEN prod_child.onoffer = 1 AND prod_child.offerprice > 399 AND prod_child.offerprice < prod_child.rrp THEN CONCAT(FLOOR(prod_child.rrp),'.00')
...
WHEN prod_child.onoffer = 1 AND prod_child.offerprice <= 399 AND prod_child.offerprice >= prod_child.rrp THEN CONCAT(FLOOR(prod_child.offerprice + (prod_child.offerprice * 0.30)) + [Delivery Service 1 Price],'.00')
...
WHEN prod_child.onoffer = 1 AND prod_child.offerprice > 399 AND prod_child.offerprice >= prod_child.rrp THEN CONCAT(FLOOR(prod_child.offerprice + (prod_child.offerprice * 0.30)),'.00')
...
WHEN prod_child.onsale = 0 AND prod_child.onoffer = 0 AND prod_child.price <= 399 AND prod_child.price < prod_child.rrp THEN CONCAT(FLOOR(prod_child.rrp) + [Delivery Service 1 Price],'.00')
...
WHEN prod_child.onsale = 0 AND prod_child.onoffer = 0 AND prod_child.price > 399 AND prod_child.price < prod_child.rrp THEN CONCAT(FLOOR(prod_child.rrp),'.00')
...
WHEN prod_child.onsale = 0 AND prod_child.onoffer = 0 AND prod_child.price <= 399 AND prod_child.price >= prod_child.rrp THEN CONCAT(FLOOR(prod_child.price + (prod_child.price * 0.3)) + [Delivery Service 1 Price],'.00')
...
WHEN prod_child.onsale = 0 AND prod_child.onoffer = 0 AND prod_child.price > 399 AND prod_child.price >= prod_child.rrp THEN CONCAT(FLOOR(prod_child.price + (prod_child.price * 0.3)),'.00')
...
-- PRODUCT QUANTITY
CASE 
WHEN ebay.eStatus = 'EBAY ONLY' THEN '1'
