...
CONCAT(
'<p style="font-size:16px;text-align:justify">This ',ebay.eTitle,' ', ebay.Shape, ' ', ebay.Type,
' mirror comes in a ',LOWER(CASE WHEN prod_child.[modern traditional] = 'M' THEN 'Modern ' ELSE 'Traditional ' END),
