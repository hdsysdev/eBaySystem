...
CONCAT(
'<p style="font-size:16px;text-align:justify">These wall mounted ', ebay.[Range name], ebay.Type, ' comes in a ', ebay.[Main colour], ' finish with a ', (CASE WHEN prod_child.[modern traditional] = 'M' THEN 'modern' ELSE 'traditional' END),
