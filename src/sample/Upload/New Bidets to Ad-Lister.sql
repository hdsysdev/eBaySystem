...
CONCAT(
'<p style="font-size:16px;text-align:justify">This ', ebay.[Range name], ebay.Type, ' from ', ebay.brand, ' comes in ', (CASE WHEN prod_child.[modern traditional] = 'M' THEN 'modern' ELSE 'traditional' END), ebay.[Main Colour], ' and is ',
 ebay.Side,' in its fitting making it a perfect and relevant replacement or addition to any bathroom.</p>',
